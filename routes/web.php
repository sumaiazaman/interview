...
// Buffer Posting 
Route::get('/buffer-posting/', 'BufferPostingController@buffer_posting')->name('buffer-posting');
Route::get('/group-search/', 'BufferPostingController@group_search')->name('group-search');
